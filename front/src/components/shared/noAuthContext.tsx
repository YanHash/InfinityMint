        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100 p-6">
            <Card className="max-w-2xl w-full shadow-lg">
                <CardHeader className="text-center">
                    <CardTitle className="text-3xl font-semibold">Connect your Wallet</CardTitle>
                    <CardDescription className="text-lg text-gray-500 mt-2">
                        Sell & Buy your favorite digital art pieces backed by blockchain technology for secure ownership.
                    </CardDescription>
                </CardHeader>
