...
import {useCreateCollection, useGetCollection, useListNFT,} from "@/blockchain/hooks/marketplaceHook";
import {
    Dialog,
    DialogContent,
    DialogDescription,
...
export default function List() {
    ...
    return (
        <div
            className="flex items-center justify-center h-screen  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-whitebg-gradient-to-r from-10% via-30% to-90%">
